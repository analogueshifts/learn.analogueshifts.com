        ...
        <div className="mobile:w-[75%] w-[85%] mobile:max-w-[850px] mx-auto flex flex-col">
          ...
          <div className="w-full flex gap-3">
            <button
              ...
              className="w-max tablet:px-5 px-3 bg-dimLight h-12 flex justify-center items-center duration-300 hover:bg-dimLight/90 text-white text-[13px] tablet:text-base mt-7 font-medium rounded-[6px]"
            >
              Download Course Outline
            </button>
            <button
              onClick={() => scrollToSection("payment-plan")}
              className="w-max px-3 tablet:px-5 bg-dimLight h-12 flex justify-center items-center duration-300 hover:bg-dimLight/90 text-white text-[13px] tablet:text-base mt-7 font-medium rounded-[6px]"
            >
              Register Now
            </button>
          </div>
