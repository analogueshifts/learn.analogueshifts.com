        ...
        <div className="mobile:w-[75%] w-[85%] mobile:max-w-[850px] mx-auto flex flex-col">
          ...
          <div className="w-full flex gap-3">
            <button
              ...
              className="w-max px-5 bg-dimLight h-12 flex justify-center items-center duration-300 hover:bg-dimLight/90 text-white text-base mt-7 font-medium rounded-[6px]"
            >
