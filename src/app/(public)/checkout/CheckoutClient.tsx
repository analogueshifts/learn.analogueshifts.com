    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
      ...
      <div className="lg:col-span-6 space-y-10">
        <div className="border-b border-gray-100 pb-8">
          <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight mb-3">Secure Checkout</h1>
      ...
      <div className="lg:col-span-6">
        <div className="bg-white rounded-[2.5rem] p-8 lg:p-10 shadow-none border-2 border-background-darkYellow/20 sticky top-28 relative overflow-hidden">
          {/* Top accent bar */}
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-6 mb-8 pb-8 border-b border-gray-200 border-dashed">
              {cartItems.map((item) => (
                <div key={item.id} className="flex gap-4 relative group">
                  ...
                  <button 
                    ...
                    className="absolute -right-2 top-1/2 -translate-y-1/2 p-2 text-gray-300 hover:text-red-500 hover:bg-red-50 rounded-xl transition-colors opacity-0 group-hover:opacity-100"
            ...
            <div className="flex justify-between items-end mb-10">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-gray-500 mb-1">Total due today</span>
                <span className="text-5xl font-extrabold text-gray-900 tracking-tight leading-none">${total.toFixed(2)}</span>
              </div>
            </div>
