...
export default function Landing() {
  ...
  return (
    <div className='h-full w-full'>
      {loading ? (
        <div className='flex justify-center items-center h-full w-full pt-28'>
          <span className='h-9 w-9 border-x-2 rounded-full animate-spin' />
        </div>
      ) : (
              ...
              <div className='w-full flex items-start gap-1.5'>
                ...
                <div className='flex flex-col'>
                  <p className='large:text-xl mb-8 text-lg font-normal text-black'>
                    ...
                    for a period of{' '}
                    <span className='font-semibold'>“4 months”</span> to
                    complete the course?
                  </p>
