...
import { Camera, Save, User, Mail, Shield, AlertTriangle, Key, Linkedin, Twitter, Globe } from "lucide-react";
import toast from "react-hot-toast";

export default function AdminProfilePage() {
  const [profileData, setProfileData] = useState({
    name: "Super Admin",
    email: "admin@analogueshifts.com",
    ...
    <div className="p-6 lg:p-10 max-w-[1400px] mx-auto space-y-8 pb-20">
      ...
      <div className="relative overflow-hidden bg-[#0F2942] rounded-3xl p-8 lg:p-10 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6 border border-[#0F2942]/20">
        ...
        <div className="relative z-10">
          <h1 className="text-3xl lg:text-4xl font-extrabold text-white tracking-tight">Admin Profile</h1>
          <p className="text-gray-300 mt-2 text-sm lg:text-base max-w-xl">Manage your administrator identity, security settings, and contact information.</p>
        </div>
            ...
            <CardContent className="px-6 pb-8 pt-0 flex flex-col items-center text-center -mt-16 relative z-10">
              ...
              <div className="w-full mt-8 bg-muted/30 rounded-2xl p-5 border border-border/50 text-left space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Clearance Level</span>
                  <span className="text-sm font-semibold text-foreground">Level 5 (Max)</span>
                </div>
                <div className="w-full h-px bg-border/50" />
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Last Login</span>
                  <span className="text-sm font-semibold text-foreground">Today, 08:42 AM</span>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="xl:col-span-8 space-y-8">
          ...
          <Card className="border-border/50 shadow-sm rounded-3xl overflow-hidden">
            <CardHeader className="bg-muted/10 border-b border-border/50 p-6 lg:p-8">
              ...
              <CardDescription>Update your administrative profile details and internal contact information.</CardDescription>
            </CardHeader>
            <CardContent className="p-6 lg:p-8 space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <Label htmlFor="name" className="text-sm font-bold text-foreground">Display Name</Label>
                ...
                <div className="space-y-3">
                  <Label htmlFor="email" className="text-sm font-bold text-foreground">Admin Email</Label>
                  <div className="relative group">
          ...
          <Card className="border-border/50 shadow-sm rounded-3xl overflow-hidden">
            <CardHeader className="bg-muted/10 border-b border-border/50 p-6 lg:p-8">
              ...
              <CardDescription>Manage your password and multi-factor authentication settings.</CardDescription>
            </CardHeader>
              ...
              {!isChangingPassword ? (
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1 max-w-md">It's recommended to rotate your administrative password every 90 days.</p>
                  </div>
                  <Button 
                    variant="outline" 
